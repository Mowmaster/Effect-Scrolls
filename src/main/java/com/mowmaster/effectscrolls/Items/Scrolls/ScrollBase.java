package com.mowmaster.effectscrolls.Items.Scrolls;
...
public class ScrollBase extends EffectItemBase
{
    ...
    public ScrollBase(Properties p_41383_) {
        super(p_41383_);
    }
    ...
    public void appendHoverText(ItemStack p_41421_, @Nullable Level p_41422_, List<Component> p_41423_, TooltipFlag p_41424_) {
        ...
        if(getEffect != null)
        {
            ...
            if(getEffect.getEffect().isInstantenous()) time = Component.translatable(MODID + ".effect_scroll.instant").getString() + getEffect.getDuration() + Component.translatable(MODID + ".effect_scroll.instant_time").getString();
        ...
        TooltipUtils.addTooltipShiftMessageMultiWithStyle(MODID,p_41423_,listy,chatty);
    }
}
